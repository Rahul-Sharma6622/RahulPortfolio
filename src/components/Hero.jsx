    ...
    >
      ...
      <div className="max-w-5xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          {/* Greeting */}
          <motion.p variants={item} className="font-mono text-slate-500 text-sm md:text-base terminal-prompt">
            Hello, World! I'm
          </motion.p>
          ...
          >
            ...
            <span
              ...
              style={{
                backgroundImage: 'linear-gradient(135deg, #00FF9C 0%, #2D9CDB 50%, #9B59FF 100%)',
              }}
            >
              Sharma
            </span>
          ...
          {/* Typewriter role */}
          <motion.div variants={item} className="font-mono text-xl md:text-2xl text-slate-400">
          ...
          >
            Final-year B.Tech CS student @ Subharti Institute, Meerut. Building
          ...
          <motion.div variants={item} className="flex items-center gap-6 pt-2">
            {[
              ...
              { icon: Mail, href: 'mailto:officialrahulsharma1875@gmail.com', label: 'Email' },
            ...
            <div className="h-px flex-1 max-w-24 bg-gradient-to-r from-neon-green/30 to-transparent" />
          </motion.div>
        </motion.div>
        ...
        {/* Right image column */}
          ...
          >
            <div className="relative w-full max-w-sm rounded-2xl border border-white/10 bg-white/5 p-2 backdrop-blur-xl">
              <img
                src="/assets/profile.jpg"
                alt="Rahul Sharma"
                className="w-full h-auto rounded-xl object-cover"
              />
              <div className="pointer-events-none absolute inset-0 rounded-xl border border-neon-green/30" />
            </div>
          </motion.div>
        ...
        >
          {[
            ...
            <div key={label} className="text-center">
              ...
              <div className="font-sans text-xs text-slate-600 mt-1">{label}</div>
            </div>
          ))}
        </motion.div>
      </div>
